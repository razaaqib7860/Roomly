  ...
  >
    <div className="mx-auto flex h-20 max-w-6xl items-center justify-between px-4 sm:h-24">
      ...
      {user ? (
        ...
        <Link
          to="/auth"
          className="inline-flex items-center rounded-full bg-primary px-5 py-2 text-sm font-semibold text-primary-foreground shadow-[var(--shadow-card)] transition hover:opacity-90 sm:text-base"
        >
          Sign in
        </Link>
      )}
